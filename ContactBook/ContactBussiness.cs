...
namespace ContactBook
{
    public class ContactBussiness
    {
        ...
        public bool UpdateContactInDatabase(Contact contact)
        {
            try
            {
                ...
                if(command.ExecuteNonQuery() == 0){
                    throw new NoDataFoundException($"No Data Found Of Id {contact.PersonId} To Update");
                }
        ...
        public void RemoveContactFromDatabase(int id)
        {
            try
            {
                OracleCommand command = new OracleCommand();
                ...
                if(command.ExecuteNonQuery() == 0)
                {
                    //throw new NoDataToUpdateContactException($"No Data of Id: {id} Found ToDelete");
                    throw new NoDataFoundException("No Data Found to Delete Contact");
                }
            }
            finally
            {
        ...
        public List<Contact>? RetrieveContacts()
        {
            ...
            try
            {
                ...
                // Return contact list to indicate success
                return contacts;
            }
            catch (OracleException ex)
            {
        ...
        public bool RetrieveContactById(int id)
        {
